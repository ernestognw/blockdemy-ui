...
import { Container, LogoContainer, Logo, Content } from './elements';
...
const Navbar = ({ shrink }) => {
  return (
    <>
      <Container color="lighter" shrink={shrink} zIndex={200} justify="flex-start">
        <LogoContainer>
          <Link href="/">
            <Logo alt="Blockdemy" src="/images/logo-black.svg" />
          </Link>
        </LogoContainer>
        <Content>
          <a
          ...
          >
            <Box height={20} width={20} color="lightDark" as={FaGithub} />
          </a>
          <a target="_blank" rel="noopener noreferrer" href="https://storybook.ui.blockdemy.com">
            <Box height={20} ml={20} width={20} color="lightDark" as={StorybookIcon} />
          </a>
        </Content>
      </Container>
    </>
